...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    pricingSubtitle: "Start free. Upgrade when you're ready. Early users keep the $9/month launch price while their subscription stays active.",
    freePlan: "Free",
    freePrice: "$0 / month",
    ...
    proPlan: "Pro",
    proPrice: "$9 / month",
    proDesc: "Launch price for early users. Keep $9/month while your subscription stays active.",
    ...
    futurePrice: "Future regular price: $19/month",
    ...
    faqQ1: "What happens if Pro later becomes $19/month?",
    faqA1: "The current launch price is $9/month. Early users keep that price while their subscription stays active. If you cancel and subscribe again later, the then-current price may apply.",
  ...
  zh: {
    ...
    // Pricing
    pricingTitle: "定价",
    pricingSubtitle: "免费开始。准备好后再升级。早期用户只要保持订阅，即可保留 $9/月首发价。",
    freePlan: "免费版",
    freePrice: "¥0 / 月",
    ...
    proPlan: "专业版",
    proPrice: "$9 / 月",
    proDesc: "早期用户首发价。只要保持订阅，即可保留 $9/月。",
    ...
    // FAQ
    faqTitle: "常见问题",
    faqQ1: "如果未来 Pro 变成 $19/月，会怎样？",
    faqA1: "当前是 $9/月首发价。早期用户只要保持订阅，就可以保留这个价格。如果取消后以后重新订阅，可能会按当时价格执行。",
    faqQ2: "可以随时取消吗？",
