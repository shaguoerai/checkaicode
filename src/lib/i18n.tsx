...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    proPlan: "Pro",
    proPrice: "$9 / month",
    proDesc: "Monthly Pro access for heavier review workflows.",
    ...
    faqQ1: "Is Pro monthly or annual?",
    faqA1: "Pro is currently monthly only. Annual billing may be added later after the launch period.",
  ...
  zh: {
    ...
    faqTitle: "常见问题",
    faqQ1: "Pro 是月付还是年付？",
    faqA1: "目前 Pro 只开放月付。年付可能会在上线后根据用户需求再加入。",
    faqQ2: "可以随时取消吗？",
