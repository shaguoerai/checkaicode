...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    proApi: "Gumroad license activation",
    ...
    teamSso: "Custom billing via Gumroad",
    ...
    gumroadStep3: "After payment, copy your license key and return here to activate Pro",
  ...
  zh: {
    ...
    gumroadStep3: "支付成功后复制 license key，回到本站激活 Pro",
