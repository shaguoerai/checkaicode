...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    pricingSubtitle: "Start free. Upgrade when you're ready. Subscribe during the launch period to keep $9/month while your subscription stays active.",
    freePlan: "Free",
    freePrice: "$0 / month",
    ...
    proPlan: "Pro",
    proPrice: "$9 / month",
    proDesc: "Launch-period price. Keep $9/month while your subscription stays active.",
    ...
    faqA1: "We have not set a date yet. We will decide based on launch traffic and subscriptions. If you subscribe during the launch period, you keep $9/month while your subscription stays active. If you cancel and subscribe again later, the then-current price may apply.",
  ...
  zh: {
    ...
    // Pricing
    pricingTitle: "定价",
    pricingSubtitle: "免费开始。准备好后再升级。首发期内订阅，只要保持订阅即可保留 $9/月。",
    freePlan: "免费版",
    freePrice: "¥0 / 月",
    ...
    faqA1: "目前还没有确定日期，会根据上线后的流量和订阅情况决定。首发期内订阅的用户，只要保持订阅即可保留 $9/月。如果取消后以后重新订阅，可能会按当时价格执行。",
    faqQ2: "可以随时取消吗？",
