...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    proExperienceDay: "New users get 24 hours of unlimited Pro features — no credit card required. Try before you buy. Auto-downgrades to Free after 24h unless you choose to upgrade.",
  ...
  zh: {
    ...
    proUnlimited: "无限代码审查（合理使用）",
    proAdvanced: "高级 AI 建议（修复 + 解释）",
    proPriority: "优先支持（24小时响应）",
    ...
    yearlySave: "省 27%",
    proExperienceDay: "Pro 体验日：新用户免费获得 24 小时无限 Pro 功能 — 无需信用卡。先试用再购买。24 小时后自动降级为免费版，除非你选择升级。",
    refundGuarantee: "7 天满意保证",
    refundDesc: "不满意？7 天内取消可全额退款。无麻烦，无罚金。",
    // FAQ
    faqTitle: "常见问题",
